                ...
                <table class="table">                    
                    <tr>
                        <td>
                            ...
                            <br>
                            <div>
                                <a href='#' onClick="fn_comment('${dto.bno }')" class="btn pull-right btn-success">등록</a>
                            </div>
                            <div> 아이디
        ...
        success : function(data){
            ...
            if(data.length > 0){
                ...
                for(i=0; i<data.length; i++){
                    html += "<div>";
                    html += "<div><h6><strong>"+data[i].writer+"</strong></h6>";
                    html += data[i].user_id + "<tr><td></td></tr>";
                    html += data[i].regdate + "<tr><td></td></tr>";
